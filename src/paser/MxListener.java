...
public interface MxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code FundationType}
	 * labeled alternative in {@link MxParser#typeName}.
	 * @param ctx the parse tree
	 */
	void enterFundationType(MxParser.FundationTypeContext ctx);
	/**
	 * Exit a parse tree produced by the {@code FundationType}
	 * labeled alternative in {@link MxParser#typeName}.
	 * @param ctx the parse tree
	 */
	void exitFundationType(MxParser.FundationTypeContext ctx);
	/**
